...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src.b59255f4.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "kK2i": [function (require, module, exports) {}, {}],
  "v8ZU": [function (require, module, exports) {
    module.exports = "/img.a01d9c51.png";
  }, {}],
  "b3qU": [function (require, module, exports) {
    "use strict";
    ...
    var e = t(require("react")),
        a = t(require("../assets/img/img.png"));
    ...
    require("./Style/Header.sass");

    var r = function r() {
      return e.default.createElement("header", null, e.default.createElement("nav", {
        className: "navbar",
        role: "navigation",
    ...
    "react": "HdMw",
    "../assets/img/img.png": "v8ZU",
    "./Style/Header.sass": "kK2i"
  }],
  "OssC": [function (require, module, exports) {
    var define;
    ...
    !function (t, r) {
      "object" === ("undefined" == typeof exports ? "undefined" : n(exports)) && "undefined" != typeof module ? module.exports = r() : "function" == typeof e && e.amd ? e(r) : (t = t || self).marked = r();
    }(this, function () {
      "use strict";
      ...
      var r,
        ...
        exports: {}
          ...
          s = (i.defaults, i.getDefaults, i.changeDefaults, /[&<>"']/),
          l = /[&<>"']/g,
          a = /[<>"']|&(?!#?\w+;)/,
          o = /[<>"']|&(?!#?\w+;)/g,
          c = {
      ...
      var y = function y(e, t) {
        if (t) {
          if (s.test(e)) return e.replace(l, u);
      ...
      var P = function () {
        ...
        return t.space = function (e) {
          ...
          if (t) {
            for (var n, r, i, s, l, a, o, c = t[0], u = t[2], p = u.length > 1, h = ")" === u[u.length - 1], g = {
              type: "list",
              raw: c,
              ordered: p,
              start: p ? +u.slice(0, -1) : "",
      ...
      M.punctuation = L(M.punctuation).replace(/punctuation/g, M._punctuation).getRegex(), M._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>", M._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*", M.em.start = L(M.em.start).replace(/punctuation/g, M._punctuation).getRegex(), M.em.middle = L(M.em.middle).replace(/punctuation/g, M._punctuation).replace(/overlapSkip/g, M._overlapSkip).getRegex(), M.em.endAst = L(M.em.endAst, "g").replace(/punctuation/g, M._punctuation).getRegex(), M.em.endUnd = L(M.em.endUnd, "g").replace(/punctuation/g, M._punctuation).getRegex(), M.strong.start = L(M.strong.start).replace(/punctuation/g, M._punctuation).getRegex(), M.strong.middle = L(M.strong.middle).replace(/punctuation/g, M._punctuation).replace(/blockSkip/g, M._blockSkip).getRegex(), M.strong.endAst = L(M.strong.endAst, "g").replace(/punctuation/g, M._punctuation).getRegex(), M.strong.endUnd = L(M.strong.endUnd, "g").replace(/punctuation/g, M._punctuation).getRegex(), M.blockSkip = L(M._blockSkip, "g").getRegex(), M.overlapSkip = L(M._overlapSkip, "g").getRegex(), M._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g, M._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, M._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, M.autolink = L(M.autolink).replace("scheme", M._scheme).replace("email", M._email).getRegex(), M._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, M.tag = L(M.tag).replace("comment", F._comment).replace("attribute", M._attribute).getRegex(), M._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, M._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, M._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, M.link = L(M.link).replace("label", M._label).replace("href", M._href).replace("title", M._title).getRegex(), M.reflink = L(M.reflink).replace("label", M._label).getRegex(), M.reflinkSearch = L(M.reflinkSearch, "g").replace("reflink", M.reflink).replace("nolink", M.nolink).getRegex(), M.normal = B({}, M), M.pedantic = B({}, M.normal, {
        ...
        link: L(/^!?\[(label)\]\((.*?)\)/).replace("label", M._label).getRegex(),
        reflink: L(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", M._label).getRegex()
      }), M.gfm = B({}, M.normal, {
        escape: L(M.escape).replace("])", "~|])").getRegex(),
        _extended_email: /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,
        url: /^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,
        _backpedal: /(?:[^?!.,:;*_~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_~)]+(?!$))+/,
        del: /^~+(?=\S)([\s\S]*?\S)~+/,
        text: /^(`+|[^`])(?:[\s\S]*?(?:(?=[\\<!\[`*~]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@))|(?= {2,}\n|[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@))/
      }), M.gfm.url = L(M.gfm.url, "i").replace("email", M.gfm._extended_email).getRegex(), M.breaks = B({}, M.gfm, {
        br: L(M.br).replace("{2,}", "*").getRegex(),
        text: L(M.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
      });
      var N = {
        block: F,
        inline: M
      ...
      var J = function () {
        function t(e) {
          this.tokens = [], this.tokens.links = Object.create(null), this.options = e || W, this.options.tokenizer = this.options.tokenizer || new P(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options;
          var t = {
            block: X.normal,
            inline: G.normal
          };
        ...
        return s.lex = function (e) {
            ...
            switch ((l = e[t]).type) {
              ...
              case "table":
                for (l.tokens = {
                  header: [],
                  cells: []
                }, i = l.header.length, n = 0; n < i; n++) {
                  l.tokens.header[n] = [], this.inlineTokens(l.header[n], l.tokens.header[n]);
                }

                for (i = l.cells.length, n = 0; n < i; n++) {
                  for (s = l.cells[n], l.tokens.cells[n] = [], r = 0; r < s.length; r++) {
                    l.tokens.cells[n][r] = [], this.inlineTokens(s[r], l.tokens.cells[n][r]);
                  }
                }
              ...
              case "list":
                for (i = l.items.length, n = 0; n < i; n++) {
          ...
          return e;
        }, s.inlineTokens = function (e, t, n, r, i) {
          var s;
          ...
          if (this.tokens.links) {
            ...
            if (o.length > 0) for (; null != (l = this.tokenizer.rules.inline.reflinkSearch.exec(a));) {
          ...
          for (; e;) {
            if (s = this.tokenizer.escape(e)) e = e.substring(s.raw.length), t.push(s);else if (s = this.tokenizer.tag(e, n, r)) e = e.substring(s.raw.length), n = s.inLink, r = s.inRawBlock, t.push(s);else if (s = this.tokenizer.link(e)) e = e.substring(s.raw.length), "link" === s.type && (s.tokens = this.inlineTokens(s.text, [], !0, r)), t.push(s);else if (s = this.tokenizer.reflink(e, this.tokens.links)) e = e.substring(s.raw.length), "link" === s.type && (s.tokens = this.inlineTokens(s.text, [], !0, r)), t.push(s);else if (s = this.tokenizer.strong(e, a, i)) e = e.substring(s.raw.length), s.tokens = this.inlineTokens(s.text, [], n, r), t.push(s);else if (s = this.tokenizer.em(e, a, i)) e = e.substring(s.raw.length), s.tokens = this.inlineTokens(s.text, [], n, r), t.push(s);else if (s = this.tokenizer.codespan(e)) e = e.substring(s.raw.length), t.push(s);else if (s = this.tokenizer.br(e)) e = e.substring(s.raw.length), t.push(s);else if (s = this.tokenizer.del(e)) e = e.substring(s.raw.length), s.tokens = this.inlineTokens(s.text, [], n, r), t.push(s);else if (s = this.tokenizer.autolink(e, H)) e = e.substring(s.raw.length), t.push(s);else if (n || !(s = this.tokenizer.url(e, H))) {
              if (s = this.tokenizer.inlineText(e, r, V)) e = e.substring(s.raw.length), i = s.raw.slice(-1), t.push(s);else if (e) {
        ...
        return t.code = function (e, t, n) {
          ...
          return r ? '<pre><code class="' + this.options.langPrefix + Y(r, !0) + '">' + (n ? e : Y(e, !0)) + "</code></pre>\n" : "<pre><code>" + (n ? e : Y(e, !0)) + "</code></pre>\n";
        }, t.blockquote = function (e) {
          return "<blockquote>\n" + e + "</blockquote>\n";
        }, t.html = function (e) {
          return e;
        ...
        return e.prototype.slug = function (e) {
          ...
          se = function () {
        function e(e) {
          this.options = e || re, this.options.renderer = this.options.renderer || new ee(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new te(), this.slugger = new ne();
        }
        ...
        return t.parse = function (e, t) {
          ...
          for (n = 0; n < w; n++) {
            switch ((p = e[n]).type) {
              ...
              case "heading":
                v += this.renderer.heading(this.parseInline(p.tokens), p.depth, ie(this.parseInline(p.tokens, this.textRenderer)), this.slugger);
                continue;

              case "code":
                v += this.renderer.code(p.text, p.lang, p.escaped);
                continue;

              case "table":
                for (c = "", o = "", s = p.header.length, r = 0; r < s; r++) {
                  o += this.renderer.tablecell(this.parseInline(p.tokens.header[r]), {
                    header: !0,
                    align: p.align[r]
                  });
                }

                for (c += this.renderer.tablerow(o), u = "", s = p.cells.length, r = 0; r < s; r++) {
                  for (o = "", l = (a = p.tokens.cells[r]).length, i = 0; i < l; i++) {
                    o += this.renderer.tablecell(this.parseInline(a[i]), {
                      header: !1,
                      align: p.align[i]
                    });
                  }
              ...
              case "blockquote":
                u = this.parse(p.tokens), v += this.renderer.blockquote(u);
                continue;

              case "list":
                for (h = p.ordered, g = p.start, f = p.loose, s = p.items.length, u = "", r = 0; r < s; r++) {
                  b = (k = p.items[r]).checked, m = k.task, d = "", k.task && (x = this.renderer.checkbox(b), f ? k.tokens.length > 0 && "text" === k.tokens[0].type ? (k.tokens[0].text = x + " " + k.tokens[0].text, k.tokens[0].tokens && k.tokens[0].tokens.length > 0 && "text" === k.tokens[0].tokens[0].type && (k.tokens[0].tokens[0].text = x + " " + k.tokens[0].tokens[0].text)) : k.tokens.unshift({
                    type: "text",
                    text: x
                  }) : d += x), d += this.parse(k.tokens, f), u += this.renderer.listitem(d, m, b);
                }
              ...
              case "html":
                v += this.renderer.html(p.text);
                continue;

              case "paragraph":
                v += this.renderer.paragraph(this.parseInline(p.tokens));
                continue;

              case "text":
                for (u = p.tokens ? this.parseInline(p.tokens) : p.text; n + 1 < w && "text" === e[n + 1].type;) {
              ...
              default:
                var y = 'Token with "' + p.type + '" type was not found.';
      ...
      function he(e, t, n) {
        ...
        if ("function" == typeof t && (n = t, t = null), t = le({}, he.defaults, t || {}), ae(t), n) {
          var r,
              i = t.highlight;
          ...
          var l = 0;
          return he.walkTokens(r, function (e) {
            "code" === e.type && (l++, setTimeout(function () {
              i(e.text, e.lang, function (t, n) {
                if (t) return s(t);
                null != n && n !== e.text && (e.text = n, e.escaped = !0), 0 === --l && s();
              });
            }, 0));
          }), void (0 === l && s());
        }
        ...
        try {
          var a = J.lex(e, t);
          return t.walkTokens && he.walkTokens(a, t.walkTokens), se.parse(a, t);
        } catch (o) {
          if (o.message += "\nPlease report this to https://github.com/markedjs/marked.", t.silent) return "<p>An error occurred:</p><pre>" + oe(o.message + "", !0) + "</pre>";
          throw o;
        }
      }

      return he.options = he.setOptions = function (e) {
        return le(he.defaults, e), ue(he.defaults), he;
      }, he.getDefaults = ce, he.defaults = pe, he.use = function (e) {
        var t = le({}, e);

        if (e.renderer && function () {
          var n = he.defaults.renderer || new ee(),
              r = function r(t) {
            var r = n[t];
            ...
            n[t] = function () {
              ...
              var a = e.renderer[t].apply(n, s);
              return !1 === a && (a = r.apply(n, s)), a;
            };
          };
          ...
          var n = he.defaults.tokenizer || new P(),
              r = function r(t) {
            var r = n[t];
        ...
        for (var r, i = n(e); !(r = i()).done;) {
          ...
          switch (t(s), s.type) {
            case "table":
              for (var l, a = n(s.tokens.header); !(l = a()).done;) {
                var o = l.value;
                he.walkTokens(o, t);
              }

              for (var c, u = n(s.tokens.cells); !(c = u()).done;) {
                for (var p, h = n(c.value); !(p = h()).done;) {
                  var g = p.value;
                  he.walkTokens(g, t);
                }
              }
            ...
            case "list":
              he.walkTokens(s.items, t);
              break;

            default:
              s.tokens && he.walkTokens(s.tokens, t);
          }
        }
      }, he.Parser = se, he.parser = se.parse, he.Renderer = ee, he.TextRenderer = te, he.Lexer = J, he.lexer = J.lex, he.Tokenizer = P, he.Slugger = ne, he.parse = he, he;
    });
  }, {}],
  "buPn": [function (require, module, exports) {
    "use strict";
    ...
    var b = require("marked"),
      ...
      function o() {
        var e;
        return u(this, o), (e = n.call(this)).state = {
          text: ""
        }, e;
      }
      ...
      return i(o, [{
        ...
        value: function value() {
          ...
          return t.default.createElement("div", {
            className: "wrapper"
          }, t.default.createElement("h2", null, "Editor"), t.default.createElement("textarea", {
            id: "editor",
            cols: "100",
            rows: "20",
            value: e,
            onChange: this.handleChange
          }), t.default.createElement("h2", null, "Preview"), t.default.createElement("div", {
            id: "preview",
  ...
  "H99C": [function (require, module, exports) {
    ...
    var r = o(require("./components/Header.js")),
        n = o(require("./components/Textarea.js"));
    ...
    var h = function (t) {
      ...
      return l(u, [{
        key: "render",
        value: function value() {
          return e.default.createElement("div", null, e.default.createElement(r.default, null), e.default.createElement("div", {
            className: "container"
          }, e.default.createElement("h1", null, "Build a Markdown preview"), e.default.createElement(n.default, null)));
        }
      }]), u;
    }();

    t.default.render(e.default.createElement(h, null), document.getElementById("root"));
  }, {
    "react": "HdMw",
    "react-dom": "X9zx",
    "./style.sass": "kK2i",
    "./components/Header.js": "b3qU",
    "./components/Textarea.js": "buPn"
  }]
}, {}, ["H99C"], null);
},{}]